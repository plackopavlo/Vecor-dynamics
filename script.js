...
const content = {
  ru: {
    ...
    /* CONTACT LABELS */
    contactHint: "Пожалуйста, введите ваше имя, email и сообщение.",
namePlaceholder: "Ваше имя",
emailPlaceholder: "Ваш email",
messagePlaceholder: "Ваше сообщение",
sendBtn: "Отправить сообщение",
parentTitle:"Материнская компания",
parentText:"Vector Dynamics s.r.o. является дочерней компанией AP Staving Group s.r.o. (www.apsg.cz). IČ: 27214320. Адрес: Meteorologická 792/29, 14200 Praha, Чешская Республика.",
parentBtn:"Перейти на сайт компании-основателя",
  ...
  en: {
    ...
    contactHint: "Please enter your name, email and your message.",
namePlaceholder: "Your name",
emailPlaceholder: "Your email",
messagePlaceholder: "Your message",
sendBtn: "Send message",
parentTitle:"Parent Company",
parentText:"Vector Dynamics s.r.o. is a дочірня компанія of AP Staving Group s.r.o. (www.apsg.cz). Company ID: 27214320. Address: Meteorologická 792/29, 14200 Praha, Czech Republic.",
parentBtn:"Visit founder company website",
...
contactTelLtLabelFooter: "Tel LT:",
  ...
  ua: {
    ...
    contactHint: "Будь ласка, введіть ваше ім’я, email та повідомлення.",
namePlaceholder: "Ваше ім’я",
emailPlaceholder: "Ваш email",
messagePlaceholder: "Ваше повідомлення",
sendBtn: "Надіслати повідомлення",
parentTitle:"Материнська компанія",
parentText:"Vector Dynamics s.r.o. є дочірньою компанією AP Staving Group s.r.o. (www.apsg.cz). IČ: 27214320. Адреса: Meteorologická 792/29, 14200 Praha, Чехія.",
parentBtn:"Перейти на сайт компанії-засновника",
...
contactTelLtLabelFooter: "Тел LT:",
  ...
  cz: {
    ...
    contactHint: "Zadejte prosím své jméno, email a zprávu.",
namePlaceholder: "Vaše jméno",
emailPlaceholder: "Váš email",
messagePlaceholder: "Vaše zpráva",
sendBtn: "Odeslat zprávu",
parentTitle:"Mateřská společnost",
parentText:"Vector Dynamics s.r.o. je dceřiná společnost AP Staving Group s.r.o. (www.apsg.cz). IČ: 27214320. Adresa: Meteorologická 792/29, 14200 Praha, Česká republika.",
parentBtn:"Přejít na web mateřské společnosti",
...
contactTelLtLabelFooter: "Tel LT:",
  ...
  de: {
    ...
    companyContactsTitle: "Kontakt",
    contactHint: "Bitte geben Sie Ihren Namen, Ihre E-Mail und Ihre Nachricht ein.",
  namePlaceholder: "Ihr Name",
  emailPlaceholder: "Ihre E-Mail",
  messagePlaceholder: "Ihre Nachricht",
  sendBtn: "Nachricht senden",
parentTitle:"Muttergesellschaft",
parentText:"Vector Dynamics s.r.o. ist eine Tochtergesellschaft von AP Staving Group s.r.o. (www.apsg.cz). IČ: 27214320. Adresse: Meteorologická 792/29, 14200 Praha, Tschechische Republik.",
parentBtn:"Zur Website des Mutterunternehmens",
...
safe("parentTitle", d.parentTitle);
safe("parentText", d.parentText);
safe("parentBtn", d.parentBtn);
...
/* ==== CONTACT FORM LIVE TRANSLATION ==== */
safe("contactHint", d.contactHint);
...
if (emailInput) emailInput.placeholder = d.emailPlaceholder;
if (messageInput) messageInput.placeholder = d.messagePlaceholder;
if (sendBtn) sendBtn.textContent = d.sendBtn;
